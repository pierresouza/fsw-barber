...
async function seedDatabase() {
  try {
    const images = [
      ...
      "https://utfs.io/f/ef45effa-415e-416d-8c4a-3221923cd10f-17n.png", // Imagem repetida
      "https://utfs.io/f/a55f0f39-31a0-4819-8796-538d68cc2a0f-17o.png", // Substituído para eliminar repetição
    ...
    for (let i = 0; i < 10; i++) {
      ...
      const barbershop = await prisma.BarberShop.create({
        data: {
          ...
          address,
          imageUrl: imageUrl,
          phone: ["(11) 99999-9999", "(11) 99999-9999"], // Use array if phones is an array
          description:
